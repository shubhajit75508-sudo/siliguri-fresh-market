...
export const FISH_SUBCAT_SEO: Record<string, FishSubcatSEO> = {
  river: {
    ...
    description:
      "Order fresh river fish online in Siliguri. Rohu, Katla, Mrigel, Bhetki from Teesta & Mahananda rivers. Cut & cleaned to order. Free deliveryutes. Siliguri Freshmart.",
    keywords: [
    ...
    contentHeading: "Why Order River Fish from Siliguri Freshmart?",
    content:
    ...
    faq: [
      { question: "What is the price of rohu fish in Siliguri?", answer: "Rohu fish at Siliguri Freshmart starts from Rs.320 per kg. Prices may vary based on daily market rates and freshness. We source directly from Teesta and Mahananda river markets, so you get the freshest catch at wholesale prices." },
      { question: "Is river fish fresh or frozen at Siliguri Freshmart?", answer: "All our river fish is 100% fresh — never frozen. We pick up the day's catch every morning from local riverbank markets and deliver withfresh to your doorstep. The fish was swimming just hours before it reaches your kitchen." },
  ...
  sea: {
    ...
    faq: [
      { question: "Is pomfret fish available in Siliguri?", answer: "Yes, Silver Pomfret (Rupchanda) is available fresh at Siliguri Freshmart. We source it from Digha and Mandarbani coastal markets. Prices start from Rs.680 per kg. Order before 4 PM for same-day delivery." },
      ...
      { question: "Can I get bombay duck fish in Siliguri?", answer: "Yes, Bombay Duck (Bombil) is available at Siliguri Freshmart. It arrives fresh from Bengal's coast. Bombay Duck is perfect for frying — coat with turmeric and salt, shallow fry until crispy. Order online at siligurifreshmart.com." },
    ],
  },
  hilsa: {
    value: "hilsa",
    ...
    faq: [
      { question: "What is hilsa fish price in Siliguri today?", answer: "Hilsa prices at Siliguri Freshmart start from Rs.1,200 per kg, depending on size and origin. Hilsa prices fluctuate daily based on the catch from Bangladesh and West Bengal rivers. Check our website or call 7029908278 for today's price." },
      ...
      { question: "How to clean and cut hilsa fish at home?", answer: "When you order from Siliguri Freshmart, we clean and cut the Hilsa exactly as you prefer — whole, steaks, or longitudinal slices. If you prefer to clean it yourself, scale the fish, make a slit along the belly, remove the guts, and wash thoroughly. Hilsa steaks are the most popular cut for traditional Bengali preparations." },
    ],
  },
  prawns: {
    value: "prawns",
    ...
    faq: [
      { question: "What is the price of tiger prawns in Siliguri?", answer: "Tiger Prawns at Siliguri Freshmart start from Rs.450 per kg. Golda Chingri (giant prawns) are priced higher due to their size and rarity. Prices vary based on daily market rates — check our website for today's prices." },
      ...
      { question: "What is golda chingri?", answer: "Golda Chingri is a giant freshwater prawn found in Bengal's rivers. It's larger than tiger prawns, with a sweet, lobster-like flavour. Golda Chingri is traditionally cooked with coconut milk (Malai Chingri) or mustard paste. Available fresh at Siliguri Freshmart." },
  ...
  exotic: {
    ...
    faq: [
      { question: "Is salmon fish available in Siliguri?", answer: "Yes, Norwegian Salmon is available at Siliguri Freshmart. We source it from certified farms and it arrives vacuum-packed for freshness. Salmon is available on a weekly restock basis — pre-order to guarantee availability. Price varies by batch." },
  ...
  other: {
    ...
    heroSub: "Seasonal specials, local favourites, and today's best catch — discover what's fresh right now at Siliguri Freshmart.",
