      ...
      {showUPIModal && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 px-3 pb-6 sm:px-0 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-3xl border border-white/10 bg-[#0d1b2a] p-6 shadow-2xl">
            ...
            <div className="mb-4">
              <label className="text-[10px] font-bold uppercase tracking-[0.10em] text-[#80949b] mb-1.5 block">UPI Transaction / Reference ID <span className="text-[#e74c3c] text-xs">*</span></label>
              <input
                type="text"
                value={upiTxnId}
              ...
              />
              <p className="text-[9px] text-[#80949b] mt-1">Enter the transaction ID from your UPI app as proof of payment</p>
            </div>
            <button
