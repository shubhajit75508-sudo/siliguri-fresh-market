          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <input
                ...
                placeholder="Pincode *"
                required
                className="rounded-xl border border-border bg-white px-3 py-2.5 text-sm tracking-widest font-bold"
              />
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col gap-1 shrink-0">
                ...
                <Button variant="ghost" size="sm" className="h-7 w-7 p-0" onClick={() => openEditForm(addr)} title="Edit">
                  <Building2 className="h-3.5 w-3.5 text-muted hover:text-brand-dark" />
                </Button>
