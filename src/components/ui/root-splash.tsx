    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex flex-col items-center justify-center gap-6 bg-[#F5F8F5]"
        >
          <style>{`
          ...
          <div className="relative">
            ...
            <div className="absolute -inset-3 rounded-2xl border-2 border-brand-fresh/20 [clip-path:inset(50%_0_0_0)]" style={{ animation: "splash-spin 2s linear infinite reverse" }} />
          </div>
