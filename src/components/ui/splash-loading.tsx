    ...
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center gap-6 bg-[#0a1f1c]">
      <div className="relative">
        <img
          ...
          alt="Fresh Mart"
          className="h-20 w-20 rounded-2xl object-cover shadow-2xl shadow-[#2ecc71]/20 animate-pulse"
        />
        <div className="absolute -inset-3 rounded-2xl border-2 border-[#2ecc71]/40 animate-[spin_2s_linear_infinite] [clip-path:inset(0_0_50%_0)]" />
        <div className="absolute -inset-3 rounded-2xl border-2 border-[#2ecc71]/20 animate-[spin_2s_linear_infinite] [clip-path:inset(50%_0_0_0)] [animation-direction:reverse]" />
      </div>
