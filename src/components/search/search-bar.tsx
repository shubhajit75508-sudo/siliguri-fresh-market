    ...
    <div className="relative w-full">
      <div className="relative">
        ...
        <input
          ...
          className="h-11 w-full rounded-full border border-border bg-surface pl-11 pr-12 text-[14px] transition-all placeholder:text-muted/80 focus:border-brand-fresh/40 focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-fresh/10"
        />
        <button
          type="button"
          disabled
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {trending.map((q) => (
                        <button
                          key={q}
                          onClick={() => go(q)}
                          className="rounded-full border border-brand-fresh/20 bg-brand-fresh/5 px-3 py-1.5 text-xs font-medium text-brand-dark hover:bg-brand-fresh/10"
                        >
                          {q}
                        </button>
                      ))}
