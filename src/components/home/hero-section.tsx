        ...
        <div className="absolute inset-0 flex flex-col justify-between p-5 sm:p-8 lg:p-10">
          <div className="flex flex-1 flex-row flex-wrap items-start justify-between gap-4 lg:gap-8 lg:flex-nowrap lg:items-center">
            <motion.div
              ...
              className="max-w-[520px] glass-card p-6"
            >
              <div className="mb-5 inline-flex items-center gap-2.5 rounded-full glass-card px-4 py-2">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link
                  href="/search"
                  className="inline-flex h-12 items-center rounded-full btn-primary-solid px-7 text-[14px] font-semibold"
                >
                  Shop fresh now
                </Link>
                <Link
                  href="/account"
                  className="inline-flex h-12 items-center rounded-full btn-glass-secondary px-7 text-[14px] font-semibold"
                >
                  My Account
                </Link>
              </div>
            ...
            <motion.div
              ...
              className="hidden sm:block max-w-[120px] sm:max-w-[300px] glass-card rounded-[16px] sm:rounded-[24px] p-3 sm:p-5 shrink-0"
            >
          ...
          >
            {[
              ...
              <div
                key={item.text}
                className="flex items-center gap-2 rounded-full glass-card px-4 py-2.5"
              >
